...
namespace HLP.GeraXml.WebService.V2_Homologacao_RecepcaoEvento_SVRS {
    using System;
    ...
    public partial class RecepcaoEvento : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public RecepcaoEvento() {
            ...
            this.Url = global::HLP.GeraXml.WebService.Properties.Settings.Default.HLP_GeraXml_WebService_V2_Homologacao_RecepcaoEvento_SVRS_RecepcaoEvento;
