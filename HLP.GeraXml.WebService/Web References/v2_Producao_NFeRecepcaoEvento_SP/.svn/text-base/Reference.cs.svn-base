...
namespace HLP.GeraXml.WebService.v2_Producao_NFeRecepcaoEvento_SP {
    using System;
    ...
    public partial class RecepcaoEvento : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public RecepcaoEvento() {
            ...
            this.Url = global::HLP.GeraXml.WebService.Properties.Settings.Default.HLP_GeraXml_WebService_v2_Producao_NFeRecepcaoEvento_SP_RecepcaoEvento;
