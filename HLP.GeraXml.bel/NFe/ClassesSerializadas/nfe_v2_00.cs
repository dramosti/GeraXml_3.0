...
//     Versão de Tempo de Execução:4.0.30319.32559
//
...
namespace HLP.GeraXml.bel.NFe.ClassesSerializadas
{
    ...
    {
        [XmlElementAttribute("infProt")]
        public infProt[] infProtField { get; set; }
    ...
    {
        [XmlIgnoreAttribute()]
        public int pk_infNfe { get; set; }

        [XmlElementAttribute("ide")]
        public ide ideField { get; set; }

        [XmlElementAttribute("emit")]
        public emit emitField { get; set; }

        [XmlElementAttribute("dest")]
        public dest destField { get; set; }

        [XmlElementAttribute("det")]
        public List<det> lDet { get; set; }

        [XmlElementAttribute("avulsa")]
        public avulsa avulsaField { get; set; }

        [XmlElementAttribute("retirada")]
        public TLocal retiradaField { get; set; }

        [XmlElementAttribute("entrega")]
        public TLocal entregaField { get; set; }

        [XmlElementAttribute("total")]
        public total totalField { get; set; }

        [XmlElementAttribute("transp")]
        public transp transpField { get; set; }

        [XmlElementAttribute("cobr")]
        public cobr cobrField { get; set; }

        [XmlElementAttribute("infAdic")]
        public infAdic infAdicField { get; set; }

        [XmlElementAttribute("exporta")]
        public exporta exportaField { get; set; }

        [XmlElementAttribute("compra")]
        public compra compraField { get; set; }

        [XmlElementAttribute("cana")]
        public cana canaField { get; set; }
    ...
    {
        [XmlAttributeAttribute("nItem")]
        public string nItem { get; set; }

        [XmlElementAttribute("prod")]
        public prod prodField { get; set; }

        [XmlElementAttribute("imposto")]
        public imposto impostoField { get; set; }
    ...
    public partial class TNFeInfNFeDetImpostoICMSICMS40
    {
        ...
        public string CST { get; set; }
        public string vICMS { get; set; }
        public string motDescICMS { get; set; }
    }
