    ...
    public class belCriaXmlNFe
    {
        ...
        public void GeraLoteXmlEnvio()
        {
            try
            {
                    ...
                    try
                    {
                        ...
                        contransp = (new XElement(pf + "transp",
                                                   ...
                                                   new XElement(pf + "transporta",
                                                       ...
                                                       (!String.IsNullOrEmpty(objtransp.belTransportadora.Uf) ? new XElement(pf + "UF", objtransp.belTransportadora.Uf.ToString()) : null)),
                (objtransp.belRetTransp.Cfop != null ? (new XElement(pf + "retTransp",
                ...
                (objtransp.belVeicTransp.Placa != null ? (new XElement(pf + "veicTransp",
                   ...
                   (objtransp.belReboque.Placa != null ? new XElement(pf + "reboque",
                   ...
                   (objtransp.belLacres.Nlacre != null ? new XElement(pf + "lacres",
