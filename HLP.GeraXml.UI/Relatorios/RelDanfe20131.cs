...
namespace HLP.GeraXml.UI.Relatorios {
    ...
    public class RelDanfe2013 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HLP.GeraXml.UI.Relatorios.RelDanfe2013.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRelDanfe2013 : Component, ICachedReport {
        
        public CachedRelDanfe2013() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RelDanfe2013 rpt = new RelDanfe2013();
            rpt.Site = this.Site;
            return rpt;
        }
