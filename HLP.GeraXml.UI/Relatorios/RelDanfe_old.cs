...
namespace HLP.GeraXml.UI.Relatorios {
    ...
    public class RelDanfe_old : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "HLP.GeraXml.UI.Relatorios.RelDanfe_old.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRelDanfe_old : Component, ICachedReport {
        
        public CachedRelDanfe_old() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RelDanfe_old rpt = new RelDanfe_old();
            rpt.Site = this.Site;
            return rpt;
        }
